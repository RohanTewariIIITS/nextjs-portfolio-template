...
const ProjectCard: React.FC<ProjectCardProps> = ({ data }) => {
  ...
  return (
    <>
      <div 
        className="group bg-secondary border-border relative flex flex-col justify-between rounded-[14px] border p-5 cursor-pointer transition-transform hover:scale-[1.02]"
