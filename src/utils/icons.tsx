...
const JavaIcon: FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      ...
      {...props}>
      <path
        d="M17.4 28.9C17.4 28.9 15.8 29.8 18.6 30.1C21.9 30.5 23.6 30.4 27.3 29.8C27.3 29.8 28.3 30.4 29.7 31C21.4 34.5 10.7 30.7 17.4 28.9Z"
        fill="#5382A1"
      />
      <path
        d="M16.3 25C16.3 25 14.5 26.2 17.3 26.5C20.9 26.9 23.8 26.9 28.6 26C28.6 26 29.3 26.7 30.5 27.1C20.5 30.8 8.8 27.3 16.3 25Z"
        fill="#5382A1"
      />
      <path
        d="M24.8 18.4C27.2 21.1 24.2 23.5 24.2 23.5C24.2 23.5 30.3 20.3 27.5 16.2C24.9 12.4 22.9 10.5 33.7 4.2C33.7 4.2 18.5 8.3 24.8 18.4Z"
        fill="#E76F00"
      />
      <path
        d="M35.7 31.6C35.7 31.6 36.9 32.6 34.4 33.4C29.7 34.9 15.3 35.4 11.2 33.5C9.8 32.8 12.6 31.9 13.5 31.7C14.4 31.5 14.9 31.5 14.9 31.5C13.2 30.3 4.2 33.8 10.1 34.9C25.7 37.5 38.6 34 35.7 31.6Z"
        fill="#5382A1"
      />
    </svg>
  )
